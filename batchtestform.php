 ...
 */
class assignfeedback_mojec_batch_test_form extends moodleform {
    /**
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'batchtestforusers',
            get_string('batchtestforusers', 'assignfeedback_mojec', count($params['users'])));
        ...
        $this->add_action_buttons(true, get_string('batchtestaction', 'assignfeedback_mojec'));
